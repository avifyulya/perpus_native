...
if($_GET['id']){
    ...
    $cek_terlambat=mysqli_query($connect, "select * from peminjaman_buku where id_peminjaman_buku = '".$id_peminjaman_buku."' ");
    ...
    mysqli_query($connect, "insert into pengembalian_buku (id_peminjaman_buku, tanggal_pengembalian,denda) value('".$id_peminjaman_buku."','".date('Y-m-d')."','".$denda."')");
